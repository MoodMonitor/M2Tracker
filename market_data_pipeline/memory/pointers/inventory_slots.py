...
class InventorySlots:
    ...
    def set_item_vid_to_slot(self, slot_id, item_vid):
        slot_offset = self.inventory_slots_pointer.get_value_for_offset_name("slot_vid", "slot_offset")(slot_id)
        self.process.write_int(self.inventory_slots_pointer.get_address_for_offsets(slot_offset), item_vid)

    def set_item_quantity_to_slot(self, slot_id, item_quantity):
        slot_offset = self.inventory_slots_pointer.get_value_for_offset_name("slot_quantity", "slot_offset")(slot_id)
        self.process.write_int(self.inventory_slots_pointer.get_address_for_offsets(slot_offset), item_quantity)